...
import com.ridderware.fuse.OrderedBehavior;

/**
 *
 * @author Jeff Ridder
 */
public class OrderedTimeStepBehavior extends OrderedBehavior
{
    ...
    {
        System.out.println("Time: "+current_time+" Agent: "+this.getAgent().toString()+" Order: "+String.valueOf(this.getOrder()));
    }
}
